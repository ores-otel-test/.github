...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`ores-otel-test`](https://github.com/ores-otel-test).

## Canonical organization links

- GitHub organization: https://github.com/ores-otel-test
- Public organization defaults: https://github.com/ores-otel-test/.github
